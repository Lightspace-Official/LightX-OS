...
.draw_end:
	...
	.box0msg1			db 'Thanks for trying out LightX OS!', 0
	...
	.t0l0				db ' Welcome to LightX OS!', 13, 10
						db 10
						db ' LightX OS was designed to be a quick, efficient and easy-to-use', 13, 10
	...
	.tsl0				db ' In LightX, there also are some handy shortcuts, which can be', 13, 10
	...
	.t6l0				db 'LightX Setup has finished.', 0
	...
	.title_msg			db 'LightX Demo tour & Initial setup', 0
	.footer_msg			db 0
