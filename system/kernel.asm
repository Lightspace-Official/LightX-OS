...
checkformenuloop:	
	...
	os_init_msg			db 'LightX Desktop', 0
...
systemfilemissing:
	...
	progoptions				db 'File manager,Text editor,Image viewer,Calculator,Clock,Terminal,Settings,ASCII art editor,Pixel art editor,Music player,Hardware checker,About LightX,Other stuff...', 0
